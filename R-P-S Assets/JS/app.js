...
function win(userChoice, computerChoice) {
    ...
    let smallUser = ('User=>').fontsize('4px').sub();
    let smallComp = ('Computer=>').fontsize('4px').sub();
    result_p.innerHTML= smallUser + convertLetter(userChoice) +"&nbsp;&nbsp;"+ smallComp + convertLetter(computerChoice) + "&nbsp;\n" + '. User Win';
